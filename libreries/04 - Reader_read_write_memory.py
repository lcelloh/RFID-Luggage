        ...
        with TertiumReader(port=PORT, rssi_enabled=rssi) as reader:
            ...
            try:
                while True:
                    ...
                    if k>1:
                        write_resp=reader.write_memory("E2801190A5030061705DABCD","E2801190A5030061705DC15F",mem_bank="01",address="02",block_num="06")
                    else:
                        write_resp="Not yet"
                        
                    
                    data=reader.read_memory("E2801190A5030061705DC15F",mem_bank="01",address="02",block_num="06")
